...
lint_msgs.set_msg("pylint_fail_low_score", "fi", dict(content="Koodisi sai liian pienet laatupisteet ({global_note:.1f} / 10.0).\nTavoite: 10.0 / 10.0."))
lint_msgs.set_msg("pylint_fail_low_score", "en", dict(content="Your code received too low quality score ({global_note:.1f} / 10.0).\nTarget: 10.0 / 10.0."))
