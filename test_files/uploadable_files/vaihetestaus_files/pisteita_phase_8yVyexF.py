...
lint_msgs = core.TranslationDict()
lint_msgs.set_msg("pylint_fail_low_score", "fi", dict(
    content="Koodisi sai liian pienet laatupisteet ({global_note:.1f} / 10.0).\nTavoite: 10.0 / 10.0.",
    hints=["Koodi ei läpäissyt tyylitarkastusta."]
))
lint_msgs.set_msg("pylint_fail_low_score", "en", dict(
    content="Your code received too low quality score ({global_note:.1f} / 10.0).\nTarget: 10.0 / 10.0.",
    hints=["Your code didn't pass the coding style test."]
))
...
if __name__ == "__main__":
    ...
    if args.check:
        ...
        out = {
            ...
            "correct": correct and lint_correct,
            "completed": completed,
