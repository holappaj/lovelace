...
custom_msgs.set_msg("PrintStudentResult", "fi", "Koodin tuloste:\n{{{{{{\n{parsed}\n}}}}}}")
custom_msgs.set_msg("PrintStudentResult", "en", "Code output:\n{{{{{{\n{parsed}\n}}}}}}")
custom_msgs.set_msg("PrintReference", "fi", "Mallituloste:\n{{{{{{\n{parsed}\n}}}}}}")
custom_msgs.set_msg("PrintReference", "en", "Reference output:\n{{{{{{\n{parsed}\n}}}}}}")
...
def select_ref(question_class, st_code, keywords, lang):
    ...
    '''
    if question_class == FORMAT_SIMPLE:
        ref = lambda s: keywords["format_str"].format(*keywords["values"])
