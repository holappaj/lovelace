...
MATRIX_INDEX_NAMES = {
    "fi": [("x", "y"), ("i", "j"), ("s", "r"), ("sarake", "rivi")],
    "en": [("x", "y"), ("i", "j"), ("c", "r"), ("col", "row")]
}

INT_LIST_ITEM_NAMES = {
    "fi": ["alkio", "n", "luku", "lukema"],
    "en": ["item", "n", "value", "count"]
}
...
class SimpleFormatTemplate(object):
    ...
    _templates = {
        "fi": [
            ...
            ("Arvo hetkellä __aika__d__: __arvo__f__", TIME_VAR_NAMES["fi"], FLOAT_VAR_NAMES["fi"]),
            ("Hetkellä __aika__d__ sijainti on __s0__d__, __s1__d__", TIME_VAR_NAMES["fi"], LOCATION_NAME_PAIRS["fi"]),
            ("Henkilön __nimi__s__ tulos: __tulos__f__", NAME_VAR_NAMES["fi"], FLOAT_VAR_NAMES["fi"]),
            ("Mittaustulos __tulos__f__ sijainnissa __paikka__s__", FLOAT_VAR_NAMES["fi"], PLACE_VAR_NAMES["fi"]),
            ("Listan __indeksi__d__. henkilö on __nimi__s__", INDEX_VAR_NAMES["fi"], NAME_VAR_NAMES["fi"]),
            ...
            ("Välitulos: __tulos__f__ (__indeksi__d__ / __n__d__)", FLOAT_VAR_NAMES["fi"], INDEX_VAR_NAMES["fi"], RANGE_NAMES["fi"]),
            ("Arvo kohdassa __piste_x__f__: __piste_y__f__", FLOAT_VAR_NAMES["fi"], FLOAT_VAR_NAMES["fi"]),
            ("Tulosten välinen ero: __erotus__f__", DIF_VAR_NAMES["fi"]),
            ...
            ("Mitä saadaan kun __luku_1__f__ kerrotaan luvulla __luku_2__d__", FLOAT_VAR_NAMES["fi"], INT_VAR_NAMES["fi"]),
            ("Laske yhteen luvut __luku_1__f__ ja __luku_2__d__", FLOAT_VAR_NAMES["fi"], INT_VAR_NAMES["fi"]),
            ("Vähennä __luku_1__d__ luvusta __luku_2__f__", INT_VAR_NAMES["fi"], FLOAT_VAR_NAMES["fi"]),
        ],

        "en": [
            ("Result: __Result__f__", FLOAT_VAR_NAMES["en"]),
            ("Location: __s0__d__, __s1___d__", LOCATION_NAME_PAIRS["en"]),
            ("Value at the moment of __time__d__: __value__f__", TIME_VAR_NAMES["en"], FLOAT_VAR_NAMES["en"]),
            ("At the moment __aika__d__ location is __s0__d__, __s1__d__", TIME_VAR_NAMES["en"], LOCATION_NAME_PAIRS["en"]),
            ("Person __name__s__ result: __result__f__", NAME_VAR_NAMES["en"], FLOAT_VAR_NAMES["en"]),
            ("Measurement result __result__f__ at location __location__s__", FLOAT_VAR_NAMES["en"], PLACE_VAR_NAMES["en"]),
            ("Lists __index__d__. person is __name__s__", INDEX_VAR_NAMES["en"], NAME_VAR_NAMES["en"]),
            ("In the square (__s0__d__, __s1__d__) is __name__s__", LOCATION_NAME_PAIRS["en"], NAME_VAR_NAMES["en"]),
            ("Lap __index__d__ / __n__d__", INDEX_VAR_NAMES["en"], RANGE_NAMES["en"]),
            ("Measured: __measurement__f__ (__status__f__)", FLOAT_VAR_NAMES["en"], FLOAT_VAR_NAMES["en"]),
            ("Interdemiate result: __result__f__ (__index__d__ / __n__d__)", FLOAT_VAR_NAMES["en"], INDEX_VAR_NAMES["en"], RANGE_NAMES["en"]),
            ("Value at location __point_x__f__: __point_y__f__", FLOAT_VAR_NAMES["en"], FLOAT_VAR_NAMES["en"]),
            ("Difference between the results: __difference__f__", DIF_VAR_NAMES["en"]),
            ("Result gained: __result__f__", MUL_VAR_NAMES["en"]),
            ("Hagrids qualities: __o1__f__, __o2__f__, __o3__d__", FLOAT_VAR_NAMES["en"], FLOAT_VAR_NAMES["en"], INT_VAR_NAMES["en"]),
            ("What do we get when __num_1__f__ is multiplied by __num_2__d__", FLOAT_VAR_NAMES["en"], INT_VAR_NAMES["en"]),
            ("Add together numbers __num_1__f__ and __num_2__d__", FLOAT_VAR_NAMES["en"], INT_VAR_NAMES["en"]),
            ("Substract __num_1__d__ from __num_2__f__", INT_VAR_NAMES["en"], FLOAT_VAR_NAMES["en"]),
        ]
    }
    ...
    def get_var_values(self):
        ...
        placeholders = self._spec_re.findall(self.template)
        for pattern in placeholders:
            vtype = pattern.split("__")[2]
            if vtype == "f":
                values.append(round(random.random() * 100, 6))
            elif vtype == "d":
                values.append(random.randint(1, 99))
            else:
                values.append("".join(random.choices(ASCII_ALL, k=random.randint(4, 8))))
    ...
    def get_rex(self, kws=False, spec=None, finalize=True):
