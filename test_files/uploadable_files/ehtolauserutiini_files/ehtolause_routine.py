...
def custom_msgs(question_class, st_code, keywords, constructor_func, var, var_2, lang):
    ...
    if question_class == COMPARISON:
        ...
        custom_msgs.set_msg("GenericErrorMsg", "en", "While executing the code, an error occured.\nCheck variable for typos, correct operator and wheter \"if\" or \"elif\" was wanted.")
        custom_msgs.set_msg("PrintReference", "en", "")
        return custom_msgs

    if question_class == VARIABLE_VALUE:
        custom_msgs.set_msg("PrintStudentResult", "fi", "\nVastauksesi oli:\n{}\n\nTarkistin rakensi ja kutsui funktion:\n{}\n\nTulos oikeassa vastauksessa:\n{}".format(highlight_wrap(st_code), highlight_wrap(constructor_func), keywords["boolean"]))
        custom_msgs.set_msg("GenericErrorMsg", "fi", "Koodia suorittaessa tapahtui virhe.\nTarkista muuttujan oikeinkirjoitus, haluttiinko muuttujan olevan tosi vai epätosi,\nsekä haluttiinko tehtävässä \"if\" vai \"elif\".")
        custom_msgs.set_msg("PrintReference", "fi", "")

        custom_msgs.set_msg("PrintStudentResult", "en", "\nYour answer was:\n{}\n\nChecker constructed and called the function:\n{}\n\nResult in a correct answer:\n{}".format(highlight_wrap(st_code), highlight_wrap(constructor_func), keywords["boolean"]))
        custom_msgs.set_msg("GenericErrorMsg", "en", "While executing the code, an error occured.\nCheck variable for typos, was the variable supposed to be True or False,\nand wheter \"if\" or \"elif\" was wanted.")
        custom_msgs.set_msg("PrintReference", "en", "")
        return custom_msgs

    if question_class == LEN_COMPARISON:
        custom_msgs.set_msg("PrintStudentResult", "fi", "\nVastauksesi oli:\n{}\n\nTarkistin rakensi ja kutsui funktion:\n{}\n\nTulos:\n{}\n\nTulos oikeassa vastauksessa:\n{}".format(highlight_wrap(st_code), highlight_wrap(constructor_func), var, var_2))
        custom_msgs.set_msg("fail_variable_value", "fi", "Väärä arvo, tarkista tehtävänanto.")
        custom_msgs.set_msg("GenericErrorMsg", "fi", "Koodia suorittaessa tapahtui virhe.\nTarkista muuttujan oikeinkirjoitus.\nTarkista haitko muuttujan pituutta oikein,\nsekä haluttiinko tehtävässä \"if\" vai \"elif\".")
        custom_msgs.set_msg("PrintReference", "fi", "")

        custom_msgs.set_msg("PrintStudentResult", "en", "\nYour answer was:\n{}\n\nChecker constructed and called the function:\n{}\n\nResult:\n{}\n\nResult in a correct answer:\n{}".format(highlight_wrap(st_code), highlight_wrap(constructor_func), var, var_2))
        custom_msgs.set_msg("fail_variable_value", "en", "Wrong value, check the assignment.")
        custom_msgs.set_msg("GenericErrorMsg", "en", "While executing the code, an error occured.\nCheck variable for typos.\n Check that you sought variables length correctly,\nand wheter \"if\" or \"elif\" was wanted.")
        custom_msgs.set_msg("PrintReference", "en", "")
        return custom_msgs
    ...
    if question_class == VARIABLE_COMPARISON:
        custom_msgs.set_msg("PrintStudentResult", "fi", "\nVastauksesi oli:\n{}\n\nTarkistin rakensi ja kutsui funktion:\n{}\n\nTulos oikeassa vastauksessa:\n{}".format(highlight_wrap(st_code), highlight_wrap(constructor_func), var))
        custom_msgs.set_msg("GenericErrorMsg", "fi", "Koodia suorittaessa tapahtui virhe.\nTarkista muuttujien oikeinkirjoitus, oikea operaattori, sekä haluttiinko tehtävässä \"if\" vai \"elif\".")
        custom_msgs.set_msg("PrintReference", "fi", "")

        custom_msgs.set_msg("PrintStudentResult", "en", "\nYour answer was:\n{}\n\nChecker constructed and called the function:\n{}\n\nResult in a correct answer:\n{}".format(highlight_wrap(st_code), highlight_wrap(constructor_func), var))
        custom_msgs.set_msg("GenericErrorMsg", "en", "While executing the code, an error occured.\nCheck variables for typos, correct operator and wheter \"if\" or \"elif\" was wanted.")
        custom_msgs.set_msg("PrintReference", "en", "")
        return custom_msgs

    if question_class == COMPOUND:
        custom_msgs.set_msg("PrintStudentResult", "fi", "\nVastauksesi oli:\n{}\n\nTarkistin rakensi ja kutsui funktion:\n{}\n\nTulos oikeassa vastauksessa:\n{}".format(highlight_wrap(st_code), highlight_wrap(constructor_func), var))
        custom_msgs.set_msg("GenericErrorMsg", "fi", "Koodia suorittaessa tapahtui virhe.\nTarkista oikeinkirjoitus, muuttujat, arvot, metodit ja haluttiinko tehtävässä \"if\" vai \"elif\".")
        custom_msgs.set_msg("PrintReference", "fi", "")

        custom_msgs.set_msg("PrintStudentResult", "en", "\nYour answer was:\n{}\n\nChecker constructed and called the function:\n{}\n\nResult in a correct answer:\n{}".format(highlight_wrap(st_code), highlight_wrap(constructor_func), var))
        custom_msgs.set_msg("GenericErrorMsg", "en", "While executing the code, an error occured.\nCheck for typos, variables, values, methods and wheter \"if\" or \"elif\" was wanted.")
        custom_msgs.set_msg("PrintReference", "en", "")
        return custom_msgs
...
def select_ref(question_class, st_code, keywords, lang, keywords_2=""):
    ...
    if question_class == COMPARISON:
        ...
        if st_statement != keywords["statement"]:
            ...
            res_st = round(var + float(val_st[0]), 2)
        ...
        return ref, constructor, res_st, None, var, res
    ...
    if question_class == VARIABLE_VALUE:
        ...
        var = gen_var(question_class, boolean=keywords["boolean"])
        def constructor(st_code):
            code_split = st_code.split(" ",1)
            st_statement = code_split[0]
            try:
...
if __name__ == "__main__":
    ...
    if args.check:
        ref, constructor, var, var_2, _, msg_var = select_ref(
            data["question_class"],
            data["answer"],
            data["params"]["raw"],
            args.lang,
