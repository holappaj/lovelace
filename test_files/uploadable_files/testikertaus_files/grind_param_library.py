...
class StrLjustMethod(BaseStrMethod):
    ...
    @staticmethod
    def get_str(lang):
        return "{:.{prec}f}".format(random.random() * 100, random.randint(2, 4))
...
class StrReplaceMethod(BaseStrMethod):
    ...
    def gen_args(lang):
        if random.randint(0, 3):
            return random.sample(ASCII_LOWER, 2)
        else:
            return random.sample(ASCII_LOWER, 2) + [random.randint(1, 3)]
...
class SimpleFormatTemplate(object):
    ...
    _templates = {
        ...
        "en": [
            ...
            ("Value at __aika__d__: __arvo__f__", TIME_VAR_NAMES["en"], FLOAT_VAR_NAMES["en"]),
            ("At __time__d__ location is __s0__d__, __s1__d__", TIME_VAR_NAMES["en"], LOCATION_NAME_PAIRS["en"]),
            ("Result of __name__s__: __result__f__", NAME_VAR_NAMES["en"], FLOAT_VAR_NAMES["en"]),
            ("Measurement __result__f__ at __location__s__", FLOAT_VAR_NAMES["en"], PLACE_VAR_NAMES["en"]),
            ("List's __index__d__. person is __name__s__", INDEX_VAR_NAMES["en"], NAME_VAR_NAMES["en"]),
            ("Tile (__s0__d__, __s1__d__) contains __name__s__", LOCATION_NAME_PAIRS["en"], NAME_VAR_NAMES["en"]),
            ("Round __index__d__ / __n__d__", INDEX_VAR_NAMES["en"], RANGE_NAMES["en"]),
            ("Measured: __measurement__f__ (__state__f__)", FLOAT_VAR_NAMES["en"], FLOAT_VAR_NAMES["en"]),
            ("Intermediate result: __result__f__ (__index__d__ / __n__d__)", FLOAT_VAR_NAMES["en"], INDEX_VAR_NAMES["en"], RANGE_NAMES["en"]),
            ("Value at __point_x__f__: __point_y__f__", FLOAT_VAR_NAMES["en"], FLOAT_VAR_NAMES["en"]),
            ("Difference between results: __difference__f__", DIF_VAR_NAMES["en"]),
            ("Product: __product__f__", MUL_VAR_NAMES["en"]),
            ("Attributes of Hagrid: __o1__f__, __o2__f__, __o3__d__", FLOAT_VAR_NAMES["en"], FLOAT_VAR_NAMES["en"], INT_VAR_NAMES["en"]),
            ("What do you get when you multiply __number_1__f__ by __number_2__d__", FLOAT_VAR_NAMES["en"], INT_VAR_NAMES["en"]),
            ("Add together __number_1__f__ and __number_2__d__", FLOAT_VAR_NAMES["en"], INT_VAR_NAMES["en"]),
            ("Subtract __number_1__d__ from __number_2__f__", INT_VAR_NAMES["en"], FLOAT_VAR_NAMES["en"]),
        ]
    }
